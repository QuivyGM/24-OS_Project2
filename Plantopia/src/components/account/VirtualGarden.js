...
const VirtualGarden = () => {
    ...
    const initialPlants = [
        {id: 1, name: "Your Plant", date: "YYYY-MM-DD", time: "00:00:00", plantSrc: "", potSrc: "/images/vg-pot-example.png", plantLeft: "138px", potLeft: "128px"},
        {id: 2, name: "Your Plant", date: "YYYY-MM-DD", time: "00:00:00", plantSrc: "", potSrc: "/images/vg-pot-example.png", plantLeft: "378px", potLeft: "368px"},
        {id: 3, name: "Your Plant", date: "YYYY-MM-DD", time: "00:00:00", plantSrc: "", potSrc: "/images/vg-pot-example.png", plantLeft: "618px", potLeft: "608px"}
    ];
...
// ---------- ---------- ---------- ---------- ----------
// water 버튼 누르면 현재 날짜, 시간 기록

    const handleWaterClick = (index) => {
        setPlants((prevPlants) => {
            const updatedPlants = [...prevPlants];
            const currentDate = new Date(); // 현재 날짜와 시간 가져오기
            updatedPlants[index].time = currentDate.toLocaleTimeString(); // 현재 시간 업데이트
            updatedPlants[index].date = currentDate.toISOString().split('T')[0]; // 현재 날짜 (YYYY-MM-DD 형식) 업데이트
            return updatedPlants;
        });
    };
...
// 식물 이름 더블 클릭해서 바꾸기
    ...
    return (
        <div className="vg-big-container">
            ...
            <div className="vg-small-container">
            <Layout_seo />
