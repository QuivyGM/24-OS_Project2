...
import '../../styles/pages/_footer.scss'; // Make sure this is included for styles
            ...
            <footer className="footer py-5">
                <div className="row logo-links">
                    <div className="col-md-3 footer-logo">
                        <img src="./images/logo.png" alt="Plantopia Logo" onClick={() => console.log('Logo clicked')} />
                    </div>
                    <div className="col-md-3 footer-links">
                        <a className="nav-link active" onClick={() => console.log('Plants clicked')} href="plants">
                            Plants
                        </a>
                        <a className="nav-link active" onClick={() => console.log('Community clicked')} href="community">
                            Community
                        </a>
                        <a className="nav-link active" onClick={() => console.log('Shop clicked')} href="shop">
                            Shop
                        </a>
                        <a className="nav-link active" onClick={() => console.log('About Us clicked')} href="aboutus">
                            About Us
                        </a>
                    </div>
                </div>
