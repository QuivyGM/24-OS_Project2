    ...
    return (
        ...
        <div className="topline" style={{ backgroundColor: "rgba(0, 0, 0, 0)" }}>
            ...
            <div className="mp-ms-title-container" style={{ top: '26px' }}>
                <div className="mp-ms-title">My Purchases</div>
                {/* My Purchases의 count */}
                <div className="mp-ms-count">3</div>
            </div>

            <div className="mp-ms-title-container" style={{ top: '381px' }}>
                <div className="mp-ms-title">My Wishlists</div>
                {/* My Wishlists의 count */}
                <div className="mp-ms-count">2</div>
            </div>

            {/* My Purchases */}
            <div className="mp-ms-container" style={{ top: '57px' }}>어떤 내용..?</div>

            {/* My Wishlists */}
            <div className="mp-ms-container" style={{ top: '440px' }}>상품 링크 출력</div>
            </div> 
        </div>
    );
};
