...
{/* --------------------------------------------------------------------------------------------------------------- */}
      ...
      <div className="main-second">
        ...
        <section className="individual-blogs py-5">
          <h2 className="text-center blog-title">Top Plant</h2>
          ...
          <div className="row ">
            <div className="col-md-5 blog-image-box">
              <img src={data.main.plantimg} alt="Blog" className="img-fluid blog-image" />
            </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                      <button class="accordion-button collapsed bg-light-blue" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <img src="./icons/Soil.png" alt="Sunlight Icon" class="me-2" width="48" height="48" /> Description
                      </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                      Aloe Vera is a succulent plant species of the genus Aloe. It is known for its medicinal properties.
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="user-comments py-5">
          ...
          <div className="comment-box p-4">
            <div className="comment-author mt-3 d-flex align-items-center">
              ...
              <div className="ms-3">
                <p className="author-name">{data.comments.username}</p>
                <p className="author-position">CBNU</p>
              </div>
            </div>
            <div className=" star-info">
              <div className="rating">4.2 ★★★★</div>
              <div className="comment-text mx-3">
                <p>{data.comments.description}</p>
              </div>
            </div>
